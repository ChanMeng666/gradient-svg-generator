...
export default function Templates() {
  ...
  return (
    <>
      ...
      />
      <Head>
        <title>Template Gallery - 235+ Professional Gradient Templates | Gradient SVG Generator</title>
        <meta name="description" content="Browse 235+ professional gradient templates across 27 categories including Path Animation, Weather, Light & Shadow, Art Movement, and Culinary effects. Perfect for GitHub headers, web projects, and design work. Free API access to all templates." />
        ...
        <meta property="og:title" content="235+ Professional Gradient Templates" />
        <meta property="og:description" content="Browse our comprehensive template gallery with gradients for every project type, including new Path-Based Text Animation, Weather, Light & Shadow, Art Movement, and Culinary categories." />
      </Head>

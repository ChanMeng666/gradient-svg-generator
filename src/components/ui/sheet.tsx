      ...
      <>
        ...
        >
          <div className="relative">
            {side === 'bottom' && <div className="mx-auto mt-2 h-1 w-12 rounded-full bg-muted" />}
            {side !== 'bottom' && (
              <button
                className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none z-10 p-1"
                onClick={onClose}
              >
                <X className="h-5 w-5" />

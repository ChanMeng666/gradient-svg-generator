/*
 * MIT License - Weather & Atmospheric Templates
...
module.exports = {
  ...
  'electric-storm': {
    ...
    colors: ['4169e1', '1e90ff', '00bfff', 'ffffff'],
    gradientType: 'lightningWeb',
    animationDuration: '5s',
    description:
      'Powerful electrical storm with bright lightning bolts and electric blue atmosphere',
  },
};

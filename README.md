...
<a href="https://gradient-svg-generator.vercel.app">
  <img src="docs/showcase/hero.webp" alt="Chromaflow home page — animated SVG gradient generator" width="100%">
</a>

![Demo: typing custom text in the visual editor, applying the Sunset Gold template, and switching animation speed](docs/showcase/demo.gif)

<details>
<summary>📱 More screenshots</summary>

| Mobile                                                                        | Template gallery (355 templates, 19 categories)                                  |
| ----------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| <img src="docs/showcase/mobile-home.webp" alt="Mobile home page" width="260"> | <img src="docs/showcase/templates-full.webp" alt="Template gallery" width="560"> |
